...
module.exports = function(deployer, networkName, accounts) {
  deployer.then(async () => {
    ...
    execAdmin(`zos create Work --init init --args ${ownerAccount(accounts)},${WorkToken.address},${requiredStake.toString()},${jobStake.toString()},${TILRoles.address}`, networkName, accounts)
  })
};
