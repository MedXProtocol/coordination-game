...
function* verifierSubmitSecretSaga({
  workTokenAddress,
  coordinationGameAddress,
  address,
  applicantsLastApplicationId
...
export const VerifierSubmitSecret = connect(mapStateToProps)(
  withSaga(verifierSubmitSecretSaga)(
    withSend(
      class _VerifierSubmitSecret extends Component {
