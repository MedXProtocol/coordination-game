...
function* verifierRowSaga({ coordinationGameAddress, applicationId }) {
...
export const VerifierRow = connect(mapStateToProps)(
  withSaga(verifierRowSaga)(
    class _VerifierRow extends Component {
